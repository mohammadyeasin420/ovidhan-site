...
# Top 500 most common English words (NGSL subset)
# These are guaranteed to be high-impact for learners.
ngsl_top500 = [
    ...
    "great", "between", "need", "large", "life", "hand", "place", "world", "high", "small",
    "own", "old", "right", "still", "mean", "may", "here", "many", "such", "follow",
    "change", "group", "big", "part", "why", "ask", "man", "different", "long", "house",
    "picture", "try", "move", "again", "animal", "point", "mother", "study", "night", "question",
    "turn", "head", "under", "story", "left", "few", "while", "along", "might", "close",
    "seem", "next", "hard", "open", "begin", "both", "paper", "together", "got", "group",
    "run", "don’t", "important", "until", "children", "side", "car", "feet", "mile", "walk",
    "white", "sea", "start", "without", "second", "late", "land", "city", "tree", "cross",
    "farm", "hard", "start", "story", "saw", "far", "sea", "draw", "left", "run",
    "don't", "while", "press", "close", "night", "real", "life", "few", "north", "book",
    ...
    "direct", "pose", "leave", "song", "measure", "state", "product", "black", "short", "numeral",
    "class", "wind", "question", "happen", "complete", "ship", "area", "half", "rock", "order",
    "fire", "south", "problem", "piece", "told", "knew", "pass", "since", "top", "whole",
    ...
    "money", "serve", "appear", "road", "map", "rain", "rule", "govern", "pull", "cold",
    "notice", "voice", "unit", "power", "town", "fine", "certain", "fly", "fall", "lead",
...
# Save to JSON
with open('top500_optimize.json', 'w', encoding='utf-8') as f:
    json.dump(ngsl_top500, f, indent=2)

print(f"Saved {len(ngsl_top500)} high-impact words to top500_optimize.json")